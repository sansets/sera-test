...
/// A [BaseStatePage] is mixin class on [State] purpose
/// to make clean state management combine with [BaseCubit]
mixin BaseStatePage<T extends StatefulWidget, C extends BaseCubit> on State<T> {
  /// The cubit where cubit extends [BaseCubit]
  late C cubit = setCubit();

  /// Set the cubit must be set in declare mixin [BaseStatePage]
  C setCubit();
