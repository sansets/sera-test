...
/// A [BaseCubit] is abstract class with extend [Cubit] purpose
/// to make clean state management combine with [BaseStatePage]
abstract class BaseCubit<T> extends Cubit<T> {
  ...
  /// Called when a [BaseStatePage] is build with [MultiBlocProvider].
  ///
  /// ```dart
  /// @override
  ...
  /// Called when a [BaseStatePage] is build with [MultiBlocListener].
  ///
  /// ```dart
  /// @override
  /// List<BlocProvider> blocProviders(BuildContext context) => [
